...
func (_m *TaskUsecase) DeleteTask(c context.Context, claims *domain.Claims, id string) error {
...
func (_m *TaskUsecase) GetTask(c context.Context, claims *domain.Claims, id string) (*domain.Task, error) {
	ret := _m.Called(c, claims, id)
...
func (_m *TaskUsecase) UpdateTask(c context.Context, claims *domain.Claims, id string, task *domain.UpdateTask) error {
